        ...
        <main className="min-h-screen relative text-gray-600">
            ...
            <div className='bg-[#F5F9F4]'>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
                    <div className="text-center mb-16">
                        <SlideUp>
                            <h2 className="text-4xl sm:text-5xl font-bold text-center mb-4">Bare-Metal Performance in a Virtual Environment</h2>
                        </SlideUp>
                        <SlideUp>
                        ...
                        <div className="lg:col-span-6 border-l border-gray-200">
                            <div className="border-b-[1px] border-b-gray-200 py-10 p-4">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <FadeIn>
                                        <h3 className="font-bold text-xl group-hover:text-white">Freelancers with irregular workloads</h3>
                                    </FadeIn>
                                </div>
                            ...
                            <div className="border-b-[1px] border-b-gray-200 py-10 p-4">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <FadeIn>
                                        <h3 className="font-bold text-xl group-hover:text-white">Studios needing to scale during crunch time</h3>
                                    </FadeIn>
                                </div>
                            ...
                            <div className="border-b-[1px] border-b-gray-200 py-10 p-4">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <FadeIn>
                                        <h3 className="font-bold text-xl group-hover:text-white">Teams looking to avoid large capital investments <br /> in hardware</h3>
                                    </FadeIn>
                                </div>
                            </div>
                        </div>
            ...
            <div className='bg-[#F5F9F4]'>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
                    <div className="text-center mb-16">
                        <SlideUp>
                            <h2 className="text-4xl sm:text-5xl font-bold text-center mb-4">Flexible Storage for All Rendering Workflows</h2>
                        </SlideUp>
                        <SlideUp>
                            <p className="text-gray-600 text-center max-w-4xl mx-auto mb-16">
                        ...
                        <div className="lg:col-span-6 border-l border-gray-200">
                            <div className="border-b-[1px] border-b-gray-200 py-10 p-4">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <FadeIn>
                                        <h3 className="font-bold text-xl group-hover:text-white">Confidential project handling</h3>
                                    </FadeIn>
                                </div>
                            ...
                            <div className="border-b-[1px] border-b-gray-200 py-10 p-4">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <FadeIn>
                                        <h3 className="font-bold text-xl group-hover:text-white">Enterprise-compliance ready</h3>
                                    </FadeIn>
                                </div>
                            ...
                            <div className="border-b-[1px] border-b-gray-200 py-10 p-4">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <FadeIn>
                                        <h3 className="font-bold text-xl group-hover:text-white">Full user control over data lifecycle</h3>
                                    </FadeIn>
                                </div>
                            </div>
                        </div>
            ...
            <div className="bg-[#F9F9F9] border-t border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
                    <SlideUp>
                        <h2 className="text-4xl sm:text-5xl font-bold mb-6">Scalable Infrastructure for Projects of Any Size</h2>
