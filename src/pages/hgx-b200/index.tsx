...
export default function HGXB200Page() {
    // 数字动画函数
            ...
            const observer = new IntersectionObserver(
                (entries, observerSelf) => {
                    if (entries[0].isIntersecting) {
                        animateNumber("inference-count", 15);
                        animateNumber("training-count", 3);
                        animateNumber("efficiency-count", 12);
        ...
        <main className="min-h-screen text-gray-600 relative">
            ...
            <div className="w-full h-[850px] lg:h-[700px] mt-[84px] bg-gradient-to-r from-[#e7f8e2] to-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-0">
                    ...
                    <div className="flex-1 flex justify-center lg:justify-end w-full mt-4 lg:mt-0">
                        <SlideUp>
                            <div className="relative w-full max-w-md lg:max-w-none mr-10">
                                <Image
                                    src="/hgx-b200/nvidia-hgx-b200.png"
                                    alt="NVIDIA HGX B200 Cluster"
                                    width={500}
                                    height={300}
            ...
            <div className='bg-[#F5F7F4]'>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:py-20 py-16">
                    ...
                    <SlideUp>
                        <div className="mb-16 group flex justify-center">
                            <Image
                                src="/hgx-b200/on-demand-architecture.png"
                                alt="On-Demand-Architecture"
                                width={400}
                                height={400}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            <SlideUp>
                                ...
                                Powering the Next <br /> Generation of AI & <br /> Accelerated Computing
                                </h2>
                            </SlideUp>
                            <SlideUp>
                        ...
                        <SlideUp>
                        <div className="group relative h-[430px] rounded-lg overflow-hidden">
                                <Image
                                    src="/hgx-b200/b200-architecture.png"
                                    alt="B200 Architecture"
                                    fill
                                    className="object-cover filter transition-transform duration-500 group-hover:scale-105"
                                />
                            </div>
                        </SlideUp>
                    </div>
                    ...
                    <div id="performance-stats" className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        ...
                        <div className="border border-gray-200 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div>
                                ...
                                <p className="text-gray-600">Real-Time Throughput
                                    <br />  VS
                                    <br />  HGX H100</p>
                            </div>
                        </div>
                        ...
                        <div className="border border-gray-200 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-gray-600">Model Training Speedup
                                <br /> VS
                                <br /> HGX H100</p>
                        </div>
                        ...
                        <div className="border border-gray-200 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-gray-600">Lower Energy Use and TCO
                                <br /> VS
                                <br /> HGX H100</p>
                        </div>
                    </div>
            ...
            <div className="bg-[#F9F9F9]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-2 sm:py-20">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
                        <div className='mt-6'>
                            <SlideUp>
                                <h2 className="text-3xl sm:text-4xl font-black mb-6">Powering the Next-level High Performance Computing</h2>
                            </SlideUp>
                            <SlideUp>
                            ...
                            <div className="flex items-start gap-4 p-6 border-b-[1px] border-b-gray-200">
                                <div>
                                    <div className="flex items-center gap-4 mb-2">
                                        ...
                                        <FadeIn>
                                            <h3 className="font-bold text-[18px]">Real-Time LLM Inference</h3>
                                        </FadeIn>
                                    </div>
                                    <FadeIn>
                                        <ul className="text-gray-600 space-y-1 pl-[50px] leading-relaxed">
                                            <li>
                            ...
                            <div className="flex items-start gap-4 p-6 border-b-[1px] border-b-gray-200">
                                <div>
                                    <div className="flex items-center gap-4 mb-2">
                                        ...
                                        <FadeIn>
                                            <h3 className="font-bold text-[18px]">Cutting-Edge Training Performance</h3>
                                        </FadeIn>
                                    </div>
                                    <FadeIn>
                                        <ul className="text-gray-600 space-y-1 pl-[50px] leading-relaxed">
                                            <li>The second-generation Transformer Engine with FP8 precision delivers 3× faster training for models like GPT MoE 1.8T. Paired with 5th-gen NVLink (1.8TB/s GPU interconnect), NVSwitch, InfiniBand, and Magnum IO software, it enables seamless scalability for enterprise AI training and large GPU clusters</li>
                                        </ul>
                                    </FadeIn>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-6 border-b-[1px] border-b-gray-200">
                                <div>
                                    <div className="flex items-center gap-4 mb-2">
                                        ...
                                        <FadeIn>
                                            <h3 className="font-bold text-[18px]">Advanced Data Analytics</h3>
                                        </FadeIn>
                                    </div>
                                    <FadeIn>
                                        <ul className="text-gray-600 space-y-1 pl-[50px] leading-relaxed">
                                            <li>Powered by NVIDIA HGX B200’s Blackwell architecture and Decompression Engine, it accelerates database queries 6× faster than CPUs and 2× faster than H100 in benchmarks. Optimized for modern formats like LZ4, Snappy, and Deflate, it enables efficient processing of large datasets, delivering high-performance analytics with minimal latency for data science workloads</li>
                                        </ul>
                                    </FadeIn>
                                </div>
                            </div>
