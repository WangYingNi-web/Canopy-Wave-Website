                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="text-center">
                            <div className="bg-white rounded-lg p-8 shadow-lg">
                                ...
                                />
                                <h3 className="text-sm font-semibold mb-4">Power Infrastructure</h3>
                        ...
                        <div className="text-center">
                            <div className="bg-white rounded-lg p-8 shadow-lg">
                                <Image
                                    ...
                                    className="mx-auto mb-6"
                                />
                                <h3 className="text-sm font-semibold mb-4">Network Connectivity</h3>
                                <p className="text-gray-600 text-sm">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-white p-8 rounded-lg shadow-lg">
                            <h3 className="text-sm font-semibold mb-6">Facility</h3>
                            <ul className="space-y-4">
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-lg">
                            <h3 className="text-sm font-semibold mb-6">Power</h3>
                            <ul className="space-y-4">
