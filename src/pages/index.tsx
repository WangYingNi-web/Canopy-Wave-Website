      ...
      <div className="w-full text-gray-600">
        ...
        <div className="w-full h-[450px] relative mt-[84px]">
          ...
          <div className="absolute inset-0 z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
              <SlideUp>
                <h1 className="text-6xl sm:text-8xl font-extrabold text-[#80B224] text-center">
        ...
        <div className="bg-[#F9F9F9] py-12 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            <SlideUp>
              <h2 className="text-4xl sm:text-5xl md:text-5xl font-bold mb-12 sm:mb-16 text-center">
