            ...
            <div className="bg-[#F9F9F9] py-12 sm:py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-8">
                    <section className="px-4 py-8">
                        <SlideUp>
                            <h1 className="text-4xl sm:text-5xl font-bold mt-8 mb-10 text-center">Privacy Policy</h1>
                        </SlideUp>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">1. Sources of personal data</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">2. Personal data we process</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">3. Why we process your personal data</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">4. Your consent when requested by applicable law</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">5. To whom we disclose your personal data</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">6. Retention of your personal data</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">10. Specific jurisdictions</h2>
                        ...
                        <h3 className="text-xl font-bold mt-8 mb-4">10.1 US</h3>
                        ...
                        <h3 className="text-xl font-bold mt-8 mb-4">10.2 Canada</h3>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">11. Your Rights</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">12. Updates</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-8 mb-4">13. Questions?</h2>
