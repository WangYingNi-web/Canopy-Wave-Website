...
export default function GB200NVL72Page() {
  ...
  return (
    <main className="min-h-screen text-gray-600 relative">
      <Header />
      <Head>
        <title>On-Demand NVIDIA GB200 NVL72 & GPU: Redefining AI Access with Flexibility, Affordability & Speed | Canopy Wave</title>
        {/* <link rel="preload" href="/gb200-nvl72/nvidia-gb200-nvl72.webp" as="image" type="image/svg+xml" /> */}
        <meta name="description" content="Access the power of the NVIDIA GB200 NVL72 without the complexity. Our flexible leasing, scalable GB200 GPU cloud options, and pre-configured racks make next-gen AI affordable and rapidly deployable." />
      </Head>
      {/* Hero Section */}
          ...
          <SlideFromLeft>
            <div className="flex-1 max-w-2xl text-center lg:text-left">
              <h1 className="text-5xl sm:text-6xl font-black text-gray-600 mb-4 lg:mb-8">
                On-Demand<br />
                <span className="text-5xl sm:text-6xl">NVIDIA GB200</span><br />
                <span className="text-5xl sm:text-6xl">NVL72</span>
              </h1>
        ...
        <div id='storage-architecture' className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <SlideUp>
            <h2 className="text-3xl sm:text-4xl font-black text-center mb-4" style={{ lineHeight: '1.3' }}>
              Why NVIDIA GB200 NVL72 on <br /> GPU Cluster Hardware Product Portfolio Clusters?
            </h2>
          </SlideUp>
