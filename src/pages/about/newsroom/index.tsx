                        ...
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="w-full md:w-1/2 bg-[#8CC63F] p-8">
                                <div className="text-white">
                                    <h2 className="text-3xl font-bold mb-4">Canopy Wave and ConfidentialMind Join Forces to Accelerate Enterprise AI Adoption</h2>
                                    <p className="mb-4">Santa Clara, United States and Espoo, Finland, April 1, 2025 – Canopy Wave is excited to announce a strategic partnership with ConfidentialMind to revolutionize AI adoption within enterprises and nation states</p>
                                </div>
                            </div>
                            ...
                            <div className="w-full md:w-1/2 p-8">
                                ...
                                <div className="mb-6">
                                    <p className="font-semibold mb-2">This collaboration brings together Canopy Wave’s cutting-edge instant GPU clusters and ConfidentialMind’s deep AI expertise to provide businesses with a seamless, turn-key solution for deploying AI applications</p>
                                </div>
                                <button
                                    onClick={handleWatchClick}
                                    className="bg-[#8CC63F] text-white px-6 py-2 rounded-md hover:bg-[#7ab32f]"
                                >
                                    Watch
                                </button>
