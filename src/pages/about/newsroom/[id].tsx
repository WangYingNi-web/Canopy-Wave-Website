      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        <div className="bg-[#F9F9F9] rounded-lg shadow-xl overflow-hidden my-8">
          <div className="p-8">
            ...
            <h3 className="text-3xl font-bold mb-4">Leadership Quotes</h3>
            ...
            <h3 className="text-3xl font-bold mb-4">About Canopy Wave</h3>
            ...
            <h3 className="text-3xl font-bold mb-4">About ConfidentialMind</h3>
