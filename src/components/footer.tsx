        ...
        <footer className="border-t bg-[#F9F9F9]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                <div className="flex flex-col lg:flex-row lg:gap-12">
                    <div className="w-full lg:w-1/4 flex flex-col space-y-4 mb-8 lg:mb-0">
                    ...
                    <div className="w-full lg:w-3/4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="space-y-8">
                            ...
                            <div>
                                <h3 className="font-semibold mb-4 text-base">Solutions</h3>
                                <ul className="space-y-3 text-sm">
                        ...
                        <div className="space-y-8">
                            <div>
                                <h3 className="font-semibold mb-4 text-base">Pricing</h3>
                                <ul className="space-y-3 text-sm">
                            ...
                            <div>
                                <h3 className="font-semibold mb-4 text-base">Data Center</h3>
                                <ul className="space-y-3 text-sm">
