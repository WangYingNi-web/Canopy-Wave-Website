...
export default function Footer() {
    ...
    return (
        <footer className={`border-t bg-[#f9f9f9] ${router.pathname === '/test' ? 'bg-cover bg-center bg-no-repeat' : ''}`} style={router.pathname === '/test' ? { backgroundImage: 'url(/test/footer_bg.png)', backgroundSize: 'cover', backgroundPosition: 'contain', backgroundRepeat: 'no-repeat' } : {}}>
