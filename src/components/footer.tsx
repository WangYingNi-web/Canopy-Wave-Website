...
export default function Footer() {
    ...
    return (
        <footer className={`border-t bg-[#F9F9F9] ${router.pathname === '/test' ? 'bg-cover bg-center bg-no-repeat' : ''}`} style={router.pathname === '/test' ? { backgroundImage: 'url(/test/footer_bg.png)' } : {}}>
