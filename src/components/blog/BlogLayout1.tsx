...
const BlogLayout1: React.FC<BlogLayout1Props> = ({ blogPost }) => {
  return (
    <div className="max-w-[810px] mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
      <article className="prose max-w-none leading-relaxed sm:leading-loose lg:leading-[1.8]">
        <SlideUp>
            ...
            <img
              src={
                blogPost.title === "Canopy Wave Launches Next-Gen GPU Cluster with NVIDIA GB200 NVL72" 
                  ...
                  ? "/blog/ai-memory.webp"
                  : blogPost.title === "What is Natural Language Processing Techniques"
                  ? "/blog/natural-language.webp"
                  : blogPost.title === "How AI Strategies Reshape Business Ecosystems"
                  ? "/blog/ai-Strategies.webp"
                  : blogPost.title === "NVIDIA GPU: The Ideal Starting Point for AI Developers"
                  ? "/blog/NVIDIA-GPU.webp"
                  : blogPost.title === "Deep Learning vs Machine Learning"
                  ? "/blog/deep-learning.webp"
                  : blogPost.title === "Types of AI Models and Their Applications"
                  ? "/blog/types-of-ai-models.webp"
                  : blogPost.title === "When GPU Fans not Spinning"
                  ? "/blog/gpu-fans.webp"
                  : blogPost.title === "What is AI Language"
                  ? "/blog/ai-language.webp"
                  : blogPost.title === "Sora 2 and the Rising Demand for Compute in AI Video Generation"
                  ? "/blog/sora-2.webp"
                  : blogPost.title === "What is Deep Learning"
                  ? "/blog/what-deep-learning.webp"
                  : "/blog1.webp"
              }
              alt="Blog"
