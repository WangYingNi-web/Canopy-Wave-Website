                      ...
                      <div className="grid grid-cols-4 gap-8">
                            ...
                            <li>
                              <div>
                                ...
                                <ul className="pl-4 mt-2 space-y-2">
                                  ...
                                  <li><IwsLink href="/hgx-b200" className="text-gray-600 hover:text-gray-900 text-sm" onClick={() => setShowProducts(false)}><span>NVIDIA HGX B200 <span className='flash'>NEW</span></span></IwsLink></li>
                        ...
                        <div>
                          ...
                          <ul className="space-y-2 text-sm">
                            ...
                            <li><IwsLink href="/networking-services/infiniband-networkings" className="text-gray-600 hover:text-gray-900 text-sm" onClick={() => setShowProducts(false)}>InfiniBand Networking</IwsLink></li>
                            <li><IwsLink href="/networking-services/rocev2-networkings" className="text-gray-600 hover:text-gray-900 text-sm" onClick={() => setShowProducts(false)}>RoCEv2 Networking</IwsLink></li>
                          </ul>
                        </div>
                        <div>
                          <h3 className="font-semibold mb-4">
