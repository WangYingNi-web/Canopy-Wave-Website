                  ...
                  <div className="bg-[#F9F9F9] fixed left-0 right-0 py-6 px-8 pl-8 mt-[31px] shadow-lg border-t border-gray-100 z-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                      <ul className="space-y-2 text-sm">
                        ...
                        <li><IwsLink href="/networking-hardware/gb200-with-rocev2" className="text-gray-600 hover:text-gray-900 text-sm" onClick={() => { setShowSolutions(false) }}>GB200 Cluster with RoCEv2 Network Solution</IwsLink></li>
                      </ul>
                    </div>
                  </div>
                )}
