...
const EventsLayout2: React.FC<EventsLayout2Props> = ({ eventPost }) => {
...
Registered webinars: ${eventPost.title}
      `.trim()
      ...
      <article className="prose max-w-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 pr-10">
              ...
              <div className="text-left mb-12">
                ...
                <div className="flex items-center">
                  <div className="flex-shrink-0 flex items-center justify-center">
                    <Image src="/blog/human.svg" alt="Speaker icon" width={24} height={24} className='svg-gray' style={{ width: '24px', height: '24px' }} />
                  </div>
                  ...
                  <div className="flex-shrink-0 flex items-center justify-center ml-16">
                    <Image src="/blog/clock.svg" alt="Duration icon" width={24} height={24} className='svg-gray' style={{ width: '24px', height: '24px' }} />
                  </div>
            ...
            {eventPost.sections.map((section, index) => (
                ...
                <form onSubmit={handleWatchClick} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#80B224] focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed ${
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onBlur={handleBlur}
                      disabled={isSubmitting}
                      className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#80B224] focus:border-transparent bg-white disabled:bg-gray-100 disabled:cursor-not-allowed ${
